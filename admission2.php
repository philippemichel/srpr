...
nombre("adm_igs2", "IGS2", "", "0", "150", "");
nombre("adm_sofa", "SOFA", "", "0", "150", "");
...
sautl();
nombre("adm_asia_mot", "ASIA - Meilleur niveau non déficitaire moteur", "", "0", "100", "");
nombre("adm_asia_ssb", "ASIA - Meilleur niveau non déficitaire sensitif", "", "0", "112", "");
...
liste("echo", "Résulat échocardiographie", "echo", $base, "");
echo '<LABEL for = "adm_echotxt" class="labelhaut"> </label>
...
Rétractions tendineuses (liste)</textarea>';
saut();
echo '<LABEL for = "adm_retract" class="labelhaut"> </label>
